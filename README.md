...
Agent Experiment 0.7.0 requires Java 21. Add the modules your experiment needs; all three published
...
Version 0.7 uses Agent Judge 0.15 while retaining tested readers for Agent Experiment 0.5 / Judge
